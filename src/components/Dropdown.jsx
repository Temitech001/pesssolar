...
const Dropdown = () => {
  ...
  return (
    <div className="relative">
      <div className=" w-fit absolute z-0 top-[-05rem] right-[-01rem] bg-slate-100 lg:mt-[69px] flex gap-5 flex-col items-center justify-center px-6 lg:px1 lg:p-10 rounded">
